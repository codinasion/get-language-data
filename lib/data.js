...
var LanguageData = [
    ...
    {
        name: 'C++',
        fileExtension: ['cpp', 'c++', 'cc', 'cp', 'cxx', 'h', 'h++', 'hh', 'hpp', 'hxx', 'inc', 'inl', 'ipp', 'tcc', 'tpp'],
        namingConvension: 'PascalCase',
        prismTag: 'cpp',
    ...
    {
        name: 'Perl',
        fileExtension: ['pl', 'al', 'cgi', 'fcgi', 'perl', 'ph', 'plx', 'pm', 'pod', 'psgi', 't'],
        namingConvension: 'snake_case',
        prismTag: 'perl',
    ...
    {
        name: 'PHP',
        fileExtension: ['php', 'aw', 'ctp', 'fcgi', 'inc', 'php3', 'php4', 'php5', 'phps', 'phpt'],
        namingConvension: 'snake_case',
        prismTag: 'php',
